package com.zikozee.rabbitmq_consumer.retry.dlx_err_handler;

import java.io.IOException;
import java.time.LocalDateTime;

import com.zikozee.rabbitmq_consumer.rabbitmq.RabbitmqHeader;
...
public class DlxProcessingErrorHandler {
	 ...
	 * @return <code>true</code> if error handler works successfully,
